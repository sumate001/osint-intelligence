...
ollama pull gemma3:27b        # สำหรับ vision/verify keyframes (ถ้า VRAM พอ)
...
docker compose -f docker-compose.dev.yml logs -f api worker beat
...
make prod-logs      # docker compose logs -f api worker beat
```
